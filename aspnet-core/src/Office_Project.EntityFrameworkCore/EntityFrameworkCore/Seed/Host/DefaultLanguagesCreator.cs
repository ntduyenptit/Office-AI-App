...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = Office_ProjectConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(Office_ProjectDbContext context)
    {
        _context = context;
    }
