...
public abstract class Office_ProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static Office_ProjectWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(Office_ProjectWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<Office_ProjectDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<Office_ProjectDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<Office_ProjectDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<Office_ProjectDbContext, Task<T>> func)
    {
        T result;
